...
import it.maggioli.appalti.rest.entities.identities.DpunPK;

import java.math.BigDecimal;


/**
 * The persistent class for the dpun database table.
 * 
 */
@Entity
@Table(name="dpun")
public class Dpun implements Serializable {
