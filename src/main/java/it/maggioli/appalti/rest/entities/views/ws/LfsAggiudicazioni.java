...
/**
 * Classe che mappa la vista <code>vwslfsaggiudicazioni</code>
...
@Entity
@Immutable
@Table(name = "v_ws_lfs_aggiudicazioni")
public class LfsAggiudicazioni {
  @EmbeddedId
  private LfsAggiudicazioniIdentity identity = new LfsAggiudicazioniIdentity();
  ...
  @JoinColumn(
      name="codaggiudicatario",referencedColumnName = "codimp", unique=true, updatable=false)
  @Fetch(FetchMode.JOIN)
  private Impr aggiudicataria;
  
  /**
   * @return the identity
   */
  public LfsAggiudicazioniIdentity getIdentity() {
    return identity;
  }
   ...
   */
  public void setIdentity(LfsAggiudicazioniIdentity identity) {
   ...
   */
  public void setAggiudicataria(Impr aggiudicataria) {
