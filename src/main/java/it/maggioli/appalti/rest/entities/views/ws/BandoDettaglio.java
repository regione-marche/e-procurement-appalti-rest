...
/**
 * Classe che mappa la vista <code>v_ws_dettaglio_bando</code>
...
@Entity
@Immutable
@Table(name = "v_ws_dettaglio_bando")
public class BandoDettaglio implements Serializable {
  ...
  @Column(name = "codsa",insertable=false,updatable = false)
  protected String SACodice;
  @Column(name = "descsa",insertable=false,updatable = false)
  protected String SADescrizione;
  @Column(name = "descrup")
  protected String SARup;
  @Column(name = "dultagg")
  @JsonFormat(pattern = "dd-MM-yyyy hh:mm:ss")
