...
public class OepvCriterioListaDto {
	...
	public OepvCriterioListaDto() {
	}

	public OepvCriterioListaDto(String codiceLotto, long id, BigDecimal idPadre, BigDecimal ordinamentoPadre, BigDecimal ordinamento, String descrizione,
			BigDecimal punteggioMassimo, BigDecimal modpunti, BigDecimal modmanu) {
		super();
