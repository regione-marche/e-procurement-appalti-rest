...
import it.maggioli.appalti.rest.dto.BandoDettaglioDto;
 ...
 * {@link it.maggioli.appalti.rest.dto.BandoDettaglioDto BandoDettaglioDto}
 * @author gabriele.nencini
 * @see Function
 */
public class TransformBandoToBandoDettaglioDto implements Function<Bando, BandoDettaglioDto> {
  ...
  @Override
  public BandoDettaglioDto apply(Bando bando) {
    BandoDettaglioDto dto = new BandoDettaglioDto();
