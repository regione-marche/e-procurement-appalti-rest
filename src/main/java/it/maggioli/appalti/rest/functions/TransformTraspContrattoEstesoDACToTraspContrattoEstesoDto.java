...
public class TransformTraspContrattoEstesoDACToTraspContrattoEstesoDto implements Function<TraspContrattoEstesoDataAcqCig, TraspContrattoEstesoDacDto> {
  private final Map<String, List<String>> listAggByCodice;
  private final boolean aggiudicatariMultipli;
  public TransformTraspContrattoEstesoDACToTraspContrattoEstesoDto(Map<String, List<String>> listAggByCodice,boolean aggiudicatariMultipli) {
    this.listAggByCodice = listAggByCodice;
    this.aggiudicatariMultipli = aggiudicatariMultipli;
  }
  
  @Override
  public TraspContrattoEstesoDacDto apply(TraspContrattoEstesoDataAcqCig t) {
    TraspContrattoEstesoDacDto dto = new TraspContrattoEstesoDacDto();
    ...
    dto.setDataacquisizionecig(t.getDataacquisizionecig());
    return dto;
  }
