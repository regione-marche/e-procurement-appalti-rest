...
public class TransformTraspContrattoToTraspContrattoDto implements Function<TraspContratto, TraspContrattoDto> {
  private final Map<String, List<String>> listAggByCodice;
  private final boolean aggiudicatariMultipli;
  public TransformTraspContrattoToTraspContrattoDto(Map<String, List<String>> listAggByCodice,boolean aggiudicatariMultipli) {
    this.listAggByCodice = listAggByCodice;
    this.aggiudicatariMultipli = aggiudicatariMultipli;
  }
  
  @Override
  public TraspContrattoDto apply(TraspContratto t) {
    TraspContrattoDto dto = new TraspContrattoDto();
