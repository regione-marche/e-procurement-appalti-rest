...
import it.maggioli.appalti.rest.dto.VersionDto;
...
import it.maggioli.appalti.rest.manager.StazioneAppaltanteManager;
import it.maggioli.appalti.rest.manager.TabulatoUnoManager;
...
public class WsAppaltiControllerV10 {
  ...
  @Autowired
  protected BandoManager                 bandoManager;
  @Autowired
  protected EsitoManager                 esitoManager;
  @Autowired
  protected AvvisoManager                avManager;
  @Autowired
  protected AuthenticationManager                authManager;
  @Autowired
  protected L190Manager                l190Manager;
  @Autowired
  protected TraspManager                tManager;
  @Autowired
  protected WlogEventiManager wleManager;
  @Autowired
  protected StazioneAppaltanteManager saManager;
  @Autowired
  private TabulatoUnoManager tabUnoManager;
  
  @Autowired
  BuildProperties buildProperties;

  @GetMapping(value = "/status", produces = "application/problem+json")
  public ResponseEntity<Boolean> status() {
    return ResponseEntity.status(HttpStatus.OK.value()).body(true);
  }

  @ApiOperation(hidden=true,value = "Restituisce la versione dell'applicativo.", nickname = "getVersion")
  @GetMapping(path = "/getVersion", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<VersionDto> getVersion(){
    VersionDto v = new VersionDto();
    BeanUtils.copyProperties(buildProperties, v);
  ...
  @GetMapping(path = "/getElencoBandi/{page}/{pageSize}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getElencoStazioniAppaltanti", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<StazioneAppaltante>> getElencoStazioniAppaltanti() {
    return ResponseEntity.of(Optional.ofNullable(saManager.findAll()));
  }
  ...
  @GetMapping(path = "/getTipologiaAppalto", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<TabulatoDto>> getTipologiaAppalto() {
    logger.debug("Tabulati.A1007.name(): {}", TabulatiEnum.A1007.name());
    List<TabulatoDto> tab1List = tabUnoManager.findDtoByCodiceFilteringArchOrderByOrdinamento(TabulatiEnum.A1007.name());
  ...
  @GetMapping(path = "/getDettaglioBando/{riferimentoProcedura}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getDocumentoDaComunicazione/{idcomunicazione}/{iddocumento}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getDocumentoDaBando/{iddocumento}/{proceduraRiferimento}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getDocumentoDaEsito/{iddocumento}/{proceduraRiferimento}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getDocumentoDaAvviso/{iddocumento}/{proceduraRiferimento}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getAttoDocumento/{iddocumento}/{proceduraRiferimento}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getElencoEsiti/{page}/{pageSize}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getDettaglioEsito/{riferimentoProcedura}", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<DettaglioDto<DatiGeneraliDto, BandoDocumentoDto, Object>> getDettaglioEsito(
      @ApiParam(value = "Identificativo della procedura di riferimento",required = true) @PathVariable String riferimentoProcedura) {
  ...
  @GetMapping(path = "/getElencoAvvisi/{page}/{pageSize}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getDettaglioAvviso/{riferimentoProcedura}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/getTipologiaAvviso", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<List<TabulatoDto>> getTipologiaAvviso() {
    logger.debug("Tabulati.A1081.name(): {}", TabulatiEnum.A1081.name());
    return ResponseEntity.of(Optional.ofNullable(tabUnoManager.getTipologiaAvviso(TabulatiEnum.A1081.name())));
  }
...
//      ,hidden = true
  ...
  @GetMapping(path = "/trasp/getElencoStazioniAppaltanti", produces = MediaType.APPLICATION_JSON_VALUE)
...
//      ,hidden = true
  ...
  @GetMapping(path = "/trasp/getElencoDati/{page}/{pageSize}", produces = MediaType.APPLICATION_JSON_VALUE)
...
//      ,hidden = true
  ...
  @GetMapping(path = "/trasp/getElencoAdempimenti/{page}/{pageSize}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/trasp/getElencoContratti/{page}/{pageSize}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @GetMapping(path = "/trasp/getDettaglioContratto/{riferimentoProcedura}", produces = MediaType.APPLICATION_JSON_VALUE)
...
//  }
  ...
  @ApiOperation(value = "Servizio per ottenere l'elenco dei contratti esteso con la data di acquisizione del cig",authorizations = { @Authorization(value="Bearer") })
  @GetMapping(path = "/trasp/getElencoContrattiEsteso/{page}/{pageSize}", produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<PageDto<TraspContrattoEstesoDacDto>> getElencoContrattiEsteso(
      ...
      @ApiParam(example = "2020-01-15", format = "date", value = "Filtro dei Contratti con data di pubblicazione dell'esito dal") @DateTimeFormat(pattern = "yyyy-MM-dd") @RequestParam(required = false)Date dataPubblicazioneEsitoDa,
      @ApiParam(example = "2020-01-15", format = "date", value = "Filtro dei Contratti con data di pubblicazione dell'esito fino al") @DateTimeFormat(pattern = "yyyy-MM-dd") @RequestParam(required = false)Date dataPubblicazioneEsitoA,
      @ApiParam(example = "2020-01-15", format = "date", value = "Filtro dei Contratti con data di acquisizione cig dal") @DateTimeFormat(pattern = "yyyy-MM-dd") @RequestParam(required = false)Date dataAcquisizioneCigDa,
      @ApiParam(example = "2020-01-15", format = "date", value = "Filtro dei Contratti con data di acquisizione cig fino al") @DateTimeFormat(pattern = "yyyy-MM-dd") @RequestParam(required = false)Date dataAcquisizioneCigA,
      @ApiParam(hidden = true,value="Parametro hidden dove sono inserite le uffint a cui l'utente autorizzato ha visibilità")
      @RequestAttribute(name = "codein",required = true) List<String> codein,
      @ApiParam(hidden = true,value="Parametro hidden dove è inserita la syscon dell'utente")
      @RequestAttribute(name = "syscon",required = true) Long syscon
    ...
    return ResponseEntity.of(Optional.ofNullable(tManager.getContrattiEstesa(page, pageSize, cig, codiceStazioneAppaltante, oggetto,dataPubblicazioneGaraDa,dataPubblicazioneGaraA, dataPubblicazioneEsitoDa, dataPubblicazioneEsitoA, dataAcquisizioneCigDa, dataAcquisizioneCigA, codein,syscon,request.getRemoteAddr())));
  }
  
  @ApiOperation(value = "Servizio per ottenere il dettaglio del contratto esteso",authorizations = { @Authorization(value="Bearer") })
  @GetMapping(path = "/trasp/getDettaglioContrattoEsteso/{riferimentoProcedura}", produces = MediaType.APPLICATION_JSON_VALUE)
  ...
  @ApiOperation(value = "Servizio per ottenere il dettaglio del contratto esteso",authorizations = { @Authorization(value="Bearer") })
  @GetMapping(path = "/trasp/getDettaglioContrattoEsteso/**", produces = MediaType.APPLICATION_JSON_VALUE)
...
//      @ApiParam(value = "Identificativo della procedura di riferimento",required = true) @PathVariable(required = true) String riferimentoProcedura,
	  ...
	  String riferimentoProcedura = StringUtils.substringAfter(request.getRequestURI(), "/rest/appalti-ms/v1.1/trasp/getDettaglioContrattoEsteso/");
	  logger.info("riferimentoProcedura: {}",riferimentoProcedura);
    return ResponseEntity.of(Optional.ofNullable(tManager.getContrattoEsteso(riferimentoProcedura,codein,syscon,request.getRemoteAddr())));
//    return ResponseEntity.ok(new TraspContrattoDettaglioDto());
  }

  //Probabilmente questo metodo non viene richiamato da nessun client esterno
  ...
  public ResponseEntity<Long> createWlogEventi(@RequestBody(required = true) WlogeventiBase evento) throws Exception{
